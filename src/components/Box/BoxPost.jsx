  ...
  return (
    <NavLink to={`/post/${item.id}`} className="block group">
      <div className="group-hover:ring rounded-md group-hover:p-4 transition-all duration-300 ease-in-out cursor-pointer">
        <p className="font-roboto font-medium text-md md:text-lg text-gray-500 group-hover:text-gray-700 transition-colors duration-300">
          {item.date}
        </p>
        ...
        <p className="font-roboto text-sm line-clamp-2 text-justify md:leading-relaxed text-gray-600 group-hover:text-gray-800 transition-colors duration-300">
          {item.subTitle}
        </p>
      </div>
    </NavLink>
