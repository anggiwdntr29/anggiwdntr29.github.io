  ...
  return (
    <div className="bg-white dark:bg-night">
      <section className="px-6 md:px-10 flex flex-col py-4 min-h-screen max-w-screen-xl mx-auto ">
        <aside
          className={`w-3/5 h-full bg-white dark:bg-night dark:text-white fixed top-0 left-0 p-4 z-50 duration-500 transition-transform transform ${
        ...
        <nav className="flex justify-between items-center mb-6 font-sansation dark:text-white">
          ...
          <div className="hidden md:flex text-center text-lg font-medium">
            <button onClick={toggleDarkMode}>
              <h1 className="inline-block relative group cursor-pointer">
                <span>{isDark ? "Dark" : "Light"}</span>
                <span className="absolute left-0 bottom-0 h-0.5 bg-current w-0 group-hover:w-full transition-all duration-300 ease-in-out"></span>
        ...
        <footer className="flex flex-col justify-center items-center text-sm text-gray-500 dark:text-gray-400 mt-8">
